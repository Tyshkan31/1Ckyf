...
Функция СформироватьКанбан()
	...
	Категории.Добавить(СтрШаблон(ШаблонКатегории, "Новый", "Новые",                 СтруктураМассивов.МассивНовый.Массив, СформироватьКнопкуЗагрузки(), "37, 99, 235"));  // #2563EB
	Категории.Добавить(СтрШаблон(ШаблонКатегории, "ВРаботе", "В работе",            СтруктураМассивов.МассивВРаботе.Массив, СформироватьКнопкуЗагрузки(), "245, 158, 11"));  // #F59E0B
	Категории.Добавить(СтрШаблон(ШаблонКатегории, "ОжидаетКлиента", "Ожидает клиента", СтруктураМассивов.МассивОжидаетКлиента.Массив, СформироватьКнопкуЗагрузки(), "139, 92, 246")); // #8B5CF6
	Категории.Добавить(СтрШаблон(ШаблонКатегории, "Закрыто", "Закрыто",             СтруктураМассивов.МассивЗакрыто.Массив, СформироватьКнопкуЗагрузки(), "34, 197, 94"));   // #22C55E
