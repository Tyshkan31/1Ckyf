...
Процедура ОбработкаПроведения(Отказ, РежимПроведения)
	...
	Пока Выборка.Следующий() Цикл
		...
		СуммаБаллов = СуммаБаллов + Число(Выборка.Ответ.Наименование);
		СуммаВопросов = СуммаВопросов + 1;

	КонецЦикла;
	
	ПоискЗаписи = РегистрыСведений.НавыкиСотрудников.Выбрать(, , Новый Структура("Сотрудник", Респондент));
	Если ПоискЗаписи.Следующий() Тогда
