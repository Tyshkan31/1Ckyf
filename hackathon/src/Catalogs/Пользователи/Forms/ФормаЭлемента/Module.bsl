...
&НаКлиенте
Процедура ЛинияПоддержкиПриИзменении(Элемент)
	
	ЛинииПоддержкиПервая = ЛинияПоддержкиПервая();
	
	Если Объект.ЛинияПоддержки = ЛинииПоддержкиПервая Тогда
		
		Элементы.ЛинияПоддержки.Доступность = Ложь;
		
	Иначе
		
		Элементы.ЛинияПоддержки.Доступность = Истина;
...
&НаСервере
Функция ЛинияПоддержкиПервая()
	
	Возврат Перечисления.ЛинииПоддержки.Первая;
